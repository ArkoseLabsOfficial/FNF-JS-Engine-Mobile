...
class OptionsState extends MusicBeatState
{
	...
	var options:Array<String> = ['Note Colors', 'Controls', 'Adjust Delay and Combo', 'Graphics', 'Optimization', 'Game Rendering', 'Visuals and UI', 'Gameplay', 'Misc' #if mobile ,'Mobile' #end];
